...
this.config.classMap.exceptionForSpaceException}}});this._bindEvents()}if(d){var f={cssPrefix:"raffles-",resizeDelay:50,classMap:{hiddenSection:"header-section--sticky-hidden",active:"header-section--sticked",container:"header",spaceException:"header--transparent",exceptionForSpaceException:"header--breadcrumb-part"},breakpointMap:{xs:0,sm:576,md:768,lg:992,xl:1200,xxl:1380,xxxl:1600},animationDuration:400,animationEasing:"linear"},e=d("body");b.prototype.updateDocumentState=function(){this.topOffset=
...
duration:c.config.animationDuration,step:function(){c._addSpace()},complete:function(){d(this).css("height","")}});return this.$hiddenSections};b.prototype.showSections=function(){this.$hiddenSections.length&&this.$hiddenSections.stop().slideDown({easing:this.config.animationEasing,duration:this.config.animationDuration,complete:function(){d(this).css("height","")}});return this.$hiddenSections};b.prototype._bindEvents=function(){var c=d(window),a=this;c.on("scroll.rafflesStickyHeaderSection",function(b){c.scrollTop()>
a.topOffset&&!a.sticked&&a.isSuitable?a.sticky():c.scrollTop()<=a.topOffset&&a.sticked&&a.isSuitable&&a.unsticky()}).on("resize.rafflesStickyHeaderSection",function(b){a.resizeTimeOutId&&clearTimeout(a.resizeTimeOutId);a.resizeTimeOutId=setTimeout(function(){a.unsticky().updateDocumentState();c.scrollTop()>a.topOffset&&!a.sticked&&a.isSuitable&&a.sticky();a.isSuitable||a.showSections()},a.config.resizeDelay)}).trigger("scroll.rafflesStickyHeaderSection")};return b}}(window.jQuery);
