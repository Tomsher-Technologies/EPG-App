@extends('layout.member.dashboard', ['pagen' => 'Edit My Preference'])
                                    ...
                                    <div class="wrapper">
                                        <div class="row justify-content-center">
                                            <div class="col-lg-7">
                                                <!-- - - - - - - - - - - - - - Login Form - - - - - - - - - - - - - - - - -->
                                                <form method="POST"
                                                    action="{{ route('member.preference.update', $preference) }}"
                                                        ...
                                                        <div class="content-element-4">
                                                            <div class="row">
                                                                    ...
                                                                    <div class="raffles-custom-select">
                                                                        <select name="location"
                                                                            ...
                                                                            @foreach ($locations as $location)
                                                                                <option
                                                                                    {{ $location->id == $preference->location_id ? 'selected' : '' }}
                                                                                    value="{{ $location->id }}">
                                                                ...
                                                                <div class="col-sm-12 col-md-12">
                                                                    ...
                                                                    <textarea type="textarea" id="cf_name" name="preference" required placeholder="My Preference">{{ old('preference', $preference->preference) }}</textarea>
