<div class="navbar navbar-expand pr-0 navbar-light border-bottom-2" id="default-navbar" data-primary>
    ...
    <a href="{{ route('dashboard') }}" class="navbar-brand mr-16pt d-lg-none">
        <span class="avatar avatar-sm navbar-brand-icon mr-0 mr-lg-8pt">
            <span class="avatar-title rounded bg-primary">
                <img src="{{ getAdminAsset('images/logo/logo.png') }}" alt="logo" class="img-fluid" /></span>
        </span>
        <span class="d-none d-lg-block">Raffles</span>
    </a>
    ...
    <div class="nav navbar-nav flex-nowrap d-flex mr-16pt">
                    ...
                    <div class="list-group list-group-flush mb-0">
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action unread">
                            ...
                            <span class="d-flex">
                                ...
                                <span class="flex d-flex flex-column">
                                    <span class="text-black-70">Your profile
                        ...
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action">
                            ...
                            <span class="d-flex">
                                ...
                                <span class="flex d-flex flex-column">
                                    ...
                                    <span class="text-black-70">Wants to join your
                                        private group.</span>
                                </span>
                            </span>
                        </a>
                        ...
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action">
                            ...
                            <span class="d-flex">
                                ...
                                <span class="flex d-flex flex-column">
                                    <span class="text-black-70">Your deploy was
                                        successful.</span>
                                </span>
                            </span>
                        </a>
        ...
        <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="{{ route('user.profile') }}">Edit Account</a>
